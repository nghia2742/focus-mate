...
export function SettingsPanels() {
    ...
    return (
        <div className="w-full h-full flex flex-row overflow-hidden glass-heavy text-foreground">
            {/* Internal Sidebar */}
            <div className="w-64 border-r inner-glass-border inner-glass-bg flex flex-col p-4 pt-6 gap-2 shrink-0">
                <DialogHeader className="mb-6 px-2 text-left">
                    <DialogTitle className="text-xl font-bold flex items-center gap-2 glass-text">
                    ...
                    <button
                        ...
                        className={cn(
                            ...
                            activeTab === 'general' 
                                ...
                                : 'glass-text-muted hover:inner-glass-bg-hover'
                        )}
                    >
                    ...
                    <div className="flex flex-col gap-12 w-full animate-in fade-in slide-in-from-bottom-2 duration-300 pb-10">
                        <div>
                            <div className="flex items-center gap-2 mb-6">
                                ...
                                <h3 className="text-lg font-bold glass-text">Preferences</h3>
                            </div>
                            <div className="space-y-8">
                                <div>
                                    <Label className="text-sm font-bold glass-text-muted mb-4 block">Theme Preference</Label>
                                    <ThemeSetting />
                                </div>
                                <Separator className="inner-glass-border opacity-50" />
                                <div>
                                    <Label className="text-sm font-bold glass-text-muted mb-4 block">Background Image</Label>
                                    <BackgroundSetting />
                                </div>
                            </div>
                        </div>
