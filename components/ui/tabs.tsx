...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center rounded-xl glass p-1 glass-text-muted",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "data-[state=active]:glass-heavy data-[state=active]:glass-text data-[state=active]:shadow-sm",
      className
    )}
    {...props}
  />
